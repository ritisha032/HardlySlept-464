          ...
          <div className="game-result-leader" key={1}>
            {index + 1 <= 3 && (
              <div className="game-result-containerImage">
                <img className="game-result-image" loading="lazy" src='https://cdn-icons-png.flaticon.com/512/186/186037.png'/>
          ...
          {Object.keys(dados).map((leader, index) => (
            <div className="game-result-player" key={1}>
              ...
              <div className="game-result-user">
                <img className="game-result-image" src='https://cdn-icons-png.flaticon.com/512/186/186037.png' />
                <span> {leader} </span>
              </div>
